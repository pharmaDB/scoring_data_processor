...
# common value is 512, longer sentences are truncated, models above set to none
...
def rank_and_score(docs, additions_list, patent_list, num_scores=3):
    ...
    print(str(additions)[:1000])
    print(str(claims)[:1000])
    ...
    for i in range(len(additions)):
        addition_to_score_index[additions_list[i]] = sorted(
